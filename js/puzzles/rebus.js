...
ER.register({
  ...
  hints: [
    ...
    'The pictures are: 👨 MAN, 8️⃣ EIGHT (sounds like ATE), 🤧 FLU, 🔑 KEY, 👑 KING, 💊 PILL, 🦆 DUCK, 🎵 SONG. Write each word down, cross out the letters you take away, and read what is left.',
  ],
  build(body, api) {
    const { el, sfx } = ER;
    const ROWS = [
